...
fun Menu() {
    ...
    if (showShare) {
        Share(text = "Check out PredCompose, the best football prediction app. ", context = context)
    }
}
...
fun AboutUs(onDismiss: () -> Unit) {
    AlertDialog(
        ...
        text = {
            Text(
                "PredCompose is a football prediction app that provides daily betting tips and predictions for football matches. " +
...
fun Share(text: String, context: Context) {
    ...
    val sendIntent: Intent = Intent().apply {
        ...
        putExtra(
            Intent.EXTRA_TEXT,
            text + "https://play.google.com/store/apps/details?id=com.soccertips.predcompose"
        )
        type = "text/plain"
    }
        ...
        OtherFeedbackDialog(
            ...
            onSubmit = { email, message ->
                ...
                val intent = Intent(Intent.ACTION_SEND).apply {
                    ...
                    putExtra(Intent.EXTRA_SUBJECT, "PredCompose Feedback")
                    putExtra(
                        Intent.EXTRA_TEXT,
                        "$message\n\nSent from PredCompose App\nVersion: $appVersion"
                    )
                }
